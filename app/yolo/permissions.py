...
class ChallengeAuthorCanEditPermission(SafeMethodsOnlyPermission):
    ...
    def has_object_permission(self, request, view, obj=None):
        ...
        return can_edit or super(ChallengeAuthorCanEditPermission, self).has_object_permission(request, view, obj)
